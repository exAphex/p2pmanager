...
class Settings extends Component {
  ...
  onCreateNewAccount(name, type, user, password, description, address) {
    const obj = { id: uuidv1(), name: name, type: type, user: user, password: password, description: description, address: address };
    ipcRenderer.send("add-account", obj);
  }

  onUpdateAccount(id, name, user, password, description, address) {
    const obj = { id: id, name: name, user: user, password: password, description: description, address: address };
