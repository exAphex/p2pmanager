...
const getBondster = async (username, password) => {
  ...
  var retObj = { total: parseFloat(json.freeSum.amount) + json.investedSum.amount, invested: json.investedSum.amount, uninvested: parseFloat(json.freeSum.amount), profit: json.interestSum.amount, loss: json.feeSum.amount + json.additionalChargeAndDiscountSum.amount };
  return retObj;
};
