...
const priceAPI = "https://api.coingecko.com/api/v3/simple/price?vs_currencies=eur&ids=kava";
...
const getKAVA = async (address) => {
  ...
  var retObj = { total: parseFloat(total / 1000000), staked: parseFloat(stake / 1000000), rewards: parseFloat(rewards / 1000000), price: parseFloat(jsonPrice.kava.eur) };
  return retObj;
};
